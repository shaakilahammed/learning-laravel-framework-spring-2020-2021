  ...
  <tbody>
      @foreach($existingpro as $key => $data)
          <tr>
              ...
              <td>
                <a href="{{ route('existingproduct.delete',$data->id) }}">Delete</a> | 
                <a href="{{ route('existingproduct.edit',$data->id) }}">Edit</a> | 
                <a href="{{ route('existingproduct.details',$data->id) }}">Details</a>
              </td>
          </tr>
      @endforeach
  </tbody>
